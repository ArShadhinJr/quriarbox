...
const Clients = () => {
  return (
      <div className='container pt-web after after:bg-quote after:bg-no-repeat after:bg-opacity-0 after:top-[130px] after:left-[300px] overflow-hidden' >
          <CompHead title='TESTIMONIAL' desc='Our Awesome Clients' />
          <div className='md:w-8/12 mx-auto bg-white rounded-2xl py-[40px] px-[18px]'>
              ...
              <div className='flex gap-x-1 text-primary md:justify-start justify-center'>
